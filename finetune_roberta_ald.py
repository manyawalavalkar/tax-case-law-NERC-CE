"""Fine-tune RoBERTa for NER on OPENSOURCE CoNLL data."""
...
SAVE_DIR = Path("finetuned_roberta_OS")
...
def main():
    ...
    save_dir = output_dir / "finetuned_roberta_OS" if args.output_dir else SAVE_DIR
