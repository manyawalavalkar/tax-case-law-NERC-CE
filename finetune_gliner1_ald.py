"""Fine-tune GLiNER large v2.1 for NER on combined open source data -- using Urchade's hyperparameters."""
...
OUTPUT_DIR = Path("gliner1_finetuned_on_opensource")
SAVE_DIR = Path("finetuned_gliner1_os")
TRAIN_FILE = Path("data/OS_TRAINING.conll")
VAL_FILE = Path("data/OS_VALIDATION.conll")
...
def main():
    ...
    save_dir = output_dir / "finetuned_gliner1_os" if args.output_dir else SAVE_DIR
