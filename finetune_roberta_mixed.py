"""Fine-tune RoBERTa for NER on MIXED LLM and OS CoNLL data."""
...
SAVE_DIR = Path("finetuned_roberta_mixed")
...
def main():
    ...
    save_dir = output_dir / "finetuned_roberta_mixed" if args.output_dir else SAVE_DIR
