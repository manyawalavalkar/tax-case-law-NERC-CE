"""Fine-tune Legal-BERT for NER on LLM generated conll data."""
...
NUM_EPOCHS = 6
LEARNING_RATE = 2e-5
OUTPUT_DIR = Path("legalbert-ner-llm")
SAVE_DIR = Path("finetuned_legalbert_llm")
...
def main():
    ...
    save_dir = output_dir / "finetuned_legalbert_llm" if args.output_dir else SAVE_DIR
