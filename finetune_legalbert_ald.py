"""Fine-tune Legal-BERT for NER on combined open source data."""
...
NUM_EPOCHS = 6
LEARNING_RATE = 2e-5
OUTPUT_DIR = Path("legalbert-ner-os")
SAVE_DIR = Path("finetuned_legalbert_os")
...
def main():
    ...
    save_dir = output_dir / "finetuned_legalbert_os" if args.output_dir else SAVE_DIR
