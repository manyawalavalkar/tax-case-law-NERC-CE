"""Fine-tune GLiNER large v2.1 for NER on mixed LLM and open source data using Urchade's hyperparameters."""
...
OUTPUT_DIR = Path("gliner1_finetuned_on_mixed")
SAVE_DIR = Path("finetuned_gliner1_mixed")
...
def main():
    ...
    save_dir = output_dir / "finetuned_gliner1_mixed" if args.output_dir else SAVE_DIR
